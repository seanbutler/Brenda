...
#include "../../Grid.h"
#include "../components/Movement.h" // Add this include
#include <SDL3/SDL.h>
...
public:
     ...
     */
    void handleEvent(const SDL_Event &event, unsigned int uid, MovementManager &moveManager, PositionManager &posManager, const Grid &grid, int cellSize)
    {
